    ...
    return (
        <div className="hero-bg relative">
            ...
            <div className="flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto">
                ...
                <p className="text-lg mb-4">Wacth anywhere. Cancel anytime.</p>
                ...
                <form className="flex flex-col md:flex-row gap-4 w-1/2" onSubmit={handleFormSubmit}>
                    ...
                    <button className="bg-red-600  text-xl lg:text-2xl px-2 py-1 md:py-2 rounded flex justify-center items-center">Get Started
                ...
                <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2">
                    ...
                    <div className="flex-1 text-center md:text-left">
                        ...
                        <p className="text-lg md:text-xl">
                            Watch on your TVs, PlayStation, Xbox, Chromecast, Apple TV, Blu-ray players,and more.
                        </p>
                    </div>
                    {/* right side */}
            ...
            <div className="py-10 bg-black text-white">
                <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2">
                    ...
                    <div className="flex-1 text-center md:text-left">
                        ...
                        <p className="text-lg md:text-xl">
                            Stream unlimited movies and TV shows on your phone, tablet, laptop, TV.
                        </p>
                    </div>
                    {/* right side */}
            ...
            {/* 4th section */}
            <div className="py-10 bg-black text-white">
                <div className="flex m-w-6xl mx-auto items-center justify-center flex-col-reverse md:flex-row px-4 md:px-2">
                    {/* left */}
					<div className='flex-1 relative'>

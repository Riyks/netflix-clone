...
import { MOVIE_CATEGORIES, ORIGINAL_IMAGE_URL, TV_CATEGORIES } from "../../utils/constants"
...
import { useState } from "react"
 ...
 const HomeScreen = () => {
  ...
  {
    return (
      <div className="h-screen text-white elative">
         <Navbar/>
   ...
   return (
    <>
     <div className="relative h-screen text-white">
       ...
       <img src={ORIGINAL_IMAGE_URL + trendingContent?.backdrop_path} alt="hero-img" 

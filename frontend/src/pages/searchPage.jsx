...
const SearchPage = () => {
	...
	const handleSearch = async (e) => {
        ...
        try {
            ...
            // Set results only if the data is an array
            if (Array.isArray(res.data.data)) {
                
                setResults(res.data.data);  // Setting the response array directly to the state
            } else if(Array.isArray(res.data.content)){
                 setResults(res.data.content)
            }
            else{
                setResults([]);  // Handle unexpected response structures

...
import { ORIGINAL_IMAGE_URL, SMALL_IMAGE_BASE_URL } from "../utils/constants";
import WatchPageSkeleton from "../components/skeletonpage/WatchPageSkeleton";
        ...
        <div className="mx-auto container px-4 py-8 h-full">
            ...
            {trailers.length>0 &&(
                <div className="flex justify-between items-center mb-4">
                    ...
                    <button className={`bg-gray-500/70 hover:bg-gray-500 text-white py-2 px-4 rounded ${trailers.length-1?' ': ' cursor-not-allowed opacity-50'}
